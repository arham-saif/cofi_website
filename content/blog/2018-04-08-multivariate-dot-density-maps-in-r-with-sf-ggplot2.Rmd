...
Not only do these maps looks beautiful, but there is a strong argument that they do a better job of representing data than 
...
Now I'm not going to say these maps were completely and utterly inspired by the  take _alllll_ the credit for this new wave of dot-density enthusiasm... but it's great to see it gaining more traction as a method for visualising spatial data. 
...
Job's a good'un. We can compare it to a choropleth map of London seat winners...
...
* Donald Trump, who's love of a <a href="https://medium.com/tdebeus/trump-should-ignore-the-mercator-map-when-showing-election-results-52ad2d33b740" target="_blank">certain choropleth map</a> has triggered the desire for better election maps everywhere
